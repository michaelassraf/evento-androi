...
public class LimitedRangeDatePickerDialog extends DatePickerDialog {
	...
	public LimitedRangeDatePickerDialog(Context context, DatePickerDialog.OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, Calendar minDate, Calendar maxDate) {
