 ...
 * 
 * <ul>
 * <li>{@link #isValidInfrastructureTld} - validates infrastructure TLDs ( <code>.arpa</code>, etc.)</li>
 * <li>{@link #isValidGenericTld} - validates generic TLDs ( <code>.com, .org</code>, etc.)</li>
 * <li>{@link #isValidCountryCodeTld} - validates country code TLDs ( <code>.us, .uk, .cn</code>, etc.)</li>
 * </ul>
 * 
 * <p>
 * (<b>NOTE</b>: This class does not provide IP address lookup for domain names or methods to ensure that a given domain name matches a specific IP; see {@link java.net.InetAddress} for that functionality.)
 * </p>
 * 
...
public class DomainValidator implements Serializable {
	...
	/**
	 * Returns true if the specified <code>String</code> parses as a valid domain name with a recognized top-level domain. The parsing is case-sensitive.
	 * 
	 * @param domain
	...
	/**
	 * Returns true if the specified <code>String</code> matches any IANA-defined top-level domain. Leading dots are ignored if present. The search is case-sensitive.
	 * 
	 * @param tld
	...
	/**
	 * Returns true if the specified <code>String</code> matches any IANA-defined infrastructure top-level domain. Leading dots are ignored if present. The search is case-sensitive.
	 * 
	 * @param iTld
	...
	public boolean isValidInfrastructureTld(String iTld) {
		return INFRASTRUCTURE_TLD_LIST.contains(chompLeadingDot(iTld.toLowerCase(Locale.getDefault())));
	}

	/**
	 * Returns true if the specified <code>String</code> matches any IANA-defined generic top-level domain. Leading dots are ignored if present. The search is case-sensitive.
	 * 
	 * @param gTld
	...
	public boolean isValidGenericTld(String gTld) {
		return GENERIC_TLD_LIST.contains(chompLeadingDot(gTld.toLowerCase(Locale.getDefault())));
	}

	/**
	 * Returns true if the specified <code>String</code> matches any IANA-defined country code top-level domain. Leading dots are ignored if present. The search is case-sensitive.
	 * 
	 * @param ccTld
	...
	public boolean isValidCountryCodeTld(String ccTld) {
		return COUNTRY_CODE_TLD_LIST.contains(chompLeadingDot(ccTld.toLowerCase(Locale.getDefault())));
	}

	/**
	 * Returns true if the specified <code>String</code> matches any widely used "local" domains (localhost or localdomain). Leading dots are ignored if present. The search is case-sensitive.
	 * 
	 * @param iTld
	...
	private static final String[] LOCAL_TLDS = new String[] { "localhost", // RFC2606
																			// defined
