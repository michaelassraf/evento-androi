 ...
 * <p>
 * Construct the validator either for a single regular expression or a set (array) of regular expressions. By default validation is <i>case sensitive</i> but constructors are provided to allow <i>case in-sensitive</i> validation. For example to create a validator which does <i>case in-sensitive</i> validation for a set of regular expressions:
 * 
 * <pre>
