 ...
 * </p>
 * Behavior of validation is modified by passing in options: <li>ALLOW_2_SLASHES - [FALSE] Allows double '/' characters in the path component.</li> <li>
 * NO_FRAGMENT- [FALSE] By default fragments are allowed, if this option is included then fragments are flagged as illegal.</li> <li>ALLOW_ALL_SCHEMES - [FALSE] By default only http, https, and ftp are considered valid schemes. Enabling this option will let any scheme pass validation.</li>
 * 
 * <p>
 ...
 * </pre>
 * 
 * @see <a href="http://www.ietf.org/rfc/rfc2396.txt"> Uniform Resource Identifiers (URI): Generic Syntax </a>
 * 
...
public class UrlValidator implements Serializable {
	...
	/**
	 * Allow local URLs, such as http://localhost/ or http://machine/ . This enables a broad-brush check, for complex local machine name validation requirements you should create your validator with a {@link RegexValidator} instead ( {@link #UrlValidator(RegexValidator, long)})
	 */
	 ...
	 * @param options
	 *            Validation options. Set using the public constants of this class. To set multiple options, simply add them together:
	 *            <p>
	 ...
	 * 
	 * @param value
	 *            The value validation is being performed on. A <code>null</code> value is considered invalid.
	...
	/**
	 * Returns true if the authority is properly formatted. An authority is the combination of hostname and port. A <code>null</code> authority value is considered invalid.
	 * 
	 * @param authority
